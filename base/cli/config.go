...
func cliFlags() {
	...
	// Example params
	rootCmd.PersistentFlags().String("param1", defaultConfig.Param1, "example parameter 1")
	rootCmd.PersistentFlags().Int("param2", defaultConfig.Param2, "example parameter 2")
